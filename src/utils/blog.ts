...
export const isBlogCategoryRouteEnabled = true;
export const isBlogTagRouteEnabled = true;

export const blogListRobots = { index: true };
export const blogPostRobots = { index: true };
export const blogCategoryRobots = { index: true };
export const blogTagRobots = { index: true };
